...
import { DoubleArrowLeftIcon, ChevronLeftIcon, ChevronRightIcon, DoubleArrowRightIcon, Cross2Icon } from "@radix-ui/react-icons";
...
const ControlBarButton = React.forwardRef((props: any, ref: ForwardedRef<HTMLButtonElement>) => {
  
  return (
    <button {...props} className={cn(
      "control-bar-button bg-controller-dark hover:bg-controller-light",
      props.className
     )} title={props.label} onClick={props.onClick} ref={ref}>
    ...
    <div className="control-button-bar">
      <Dialog.Root open={dialogOpen} onOpenChange={setDialogOpen}>
        ...
        <Dialog.Trigger asChild>
          <ControlBarButton symbol={informationIcon} label="Puzzle information" className="info-button"></ControlBarButton>
        </Dialog.Trigger>
